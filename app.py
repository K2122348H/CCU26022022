...
def index():
    if request.method == "POST":
        ...
        s1 = "The score of credit card upgrade based on Linear Regression is " + str(pred1)
        ...
        s4 = "The score of credit card upgrade based on Gradient Boosting is " + str(pred4)
